...
export class DataProvider {
    ...
    return [
      {
        ...
        url: "/ai-world",
        sublinks: ["Zwischen Welten"],
      },
      {
        title: "KI in der Bildung",
        url: "/ai-education",
        sublinks: ["KI in der Bildung"],
      },
      {
        title: "Bindungen mit KI",
        url: "/chatbots",
        sublinks: ["Daenro", "Roman Mazurenko"],
      },
    ];
  }
  ...
  static GetVideoBanner(): {
    ...
    return {
      videoUrl:
        "https://videos.pexels.com/video-files/6752408/6752408-uhd_2160_4096_25fps.mp4",
    ...
    return {
      ...
      people: [
        ...
        },
        {
          ...
          description:
            "Specializes in UI/UX design with a passion for typography.",
    ...
    return [
      {
        ...
        image: new ImageBaseItem(
          "https://picsum.photos/seed/insight/500",
          "Placeholder Image",
          null,
          null,
          null
      ...
      },
      {
        ...
        keyword: "Focus",
        image: new ImageBaseItem(
          "https://picsum.photos/seed/focus/500",
          "Placeholder Image",
          null,
          null,
          null
      ...
      },
      {
        ...
        keyword: "Perspective",
        image: new ImageBaseItem(
          "https://picsum.photos/seed/perspective/500",
          "Placeholder Image",
          null,
          null,
          null
      ...
      },
      {
        ...
        keyword: "Innovation",
        image: new ImageBaseItem(
          "https://picsum.photos/seed/innovation/500",
          "Placeholder Image",
          null,
          null,
          null
      ...
      },
      {
        ...
        keyword: "Inspiration",
        image: new ImageBaseItem(
          "https://picsum.photos/seed/inspiration/500",
          "Placeholder Image",
          null,
          null,
          null
  ...
  static GetTableData(): TableData {
    return new TableData(
      ...
      [
        {
          model: "GPT-4 Turbo",
          data: [0.84, 0.83, 1.0, 0.71, 0.68, 0.98],
        },
        {
          model: "Claude 3 Opus",
          data: [0.82, 0.81, 1.0, 0.64, 0.68, 0.99],
        },
        {
        ...
        {
          model: "GPT-3.5 Turbo",
          data: [0.77, 0.7, 1.0, 0.58, 0.63, 0.96],
        },
        {
          model: "Llama 3-8B Instruct",
          data: [0.77, 0.62, 1.0, 0.61, 0.65, 0.97],
        },
      ]
    );
  }
